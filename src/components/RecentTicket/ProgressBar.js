...
// const ProgressBar = () => {
//   return (
//     <ol className="relative text-gray-500 border-l border-gray-200 dark:border-gray-700 dark:text-gray-400 ml-4">
  ...
  return (
    <ol className="flex items-center justify-between relative text-gray-500 border-t border-gray-200 dark:border-gray-700 dark:text-gray-400 ml-4">
      <li className="mb-10">
        ...
        <h3 className="font-medium leading-tight mt-6 mb-2">Ticket Created</h3>
        <p className="text-sm">04 July 2023 12:05:34</p>
      ...
      <li className="mb-10">
        ...
        <p className="text-sm">04 July 2023 12:05:34</p>
        <p className="text-sm">Owner: Fuzail </p>
        <p className="text-sm mt-2 text-blue-400 hover:text-blue-600 cursor-pointer">
          Click to view details
        </p>
      </li>
      <li className="mb-10">
        ...
        <h3 className="font-medium leading-tight -mt-2 mb-1">In Progress</h3>
        <p className="text-sm mt-2 text-blue-400 hover:text-blue-600 cursor-pointer">
          Click to view details
        </p>
      </li>
