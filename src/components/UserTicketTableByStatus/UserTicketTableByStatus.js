...
const UserTicketTableByStatus = ({ title, statuses }) => {
  ...
  // const [statuses] = useState(["Resolved", "Open", "New"]);
  ...
  const userBodyTemplate = (rowData) => {
    ...
    console.log("My Creared By.......", createdBy?.fullName);
...
export default UserTicketTableByStatus;
